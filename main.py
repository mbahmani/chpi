...
if __name__ == '__main__':
    ...
    # do_fanova(dataset_name="performance_data/Kmeans_results.csv",algorithm="kmeans",st=0,end=68)
    # {"RF","SVM","ET","DT","AB","GB"}
    
    for cls in {"kmeans"}:
        df=pd.read_csv("performance_data/"+cls+"_fANOVA_results_sil.csv")
        ...
        marginal_plots(sorted_values, keys, cls+" clustering_sil")